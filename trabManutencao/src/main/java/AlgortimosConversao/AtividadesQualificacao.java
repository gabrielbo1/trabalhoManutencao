 ...
 */
public class AtividadesQualificacao extends Atividades {

    public AtividadesQualificacao(List<Leiaute> lista ){
        setLista(lista);
    }
    ...
    public List<Leiaute> converLeiautes(String txt) {
        ...
        while (token.hasMoreTokens()) {
            ...
            if (linha.matches("^Descricao:")) {
                leiaute.setDescricaoAtividade(linha.replaceAll("Descricao:", ""));
